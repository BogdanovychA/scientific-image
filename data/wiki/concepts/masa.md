...
- **E = mc²** — лише окремий випадок (p = 0) повнішого співвідношення **E² = p²c² + m²c⁴**. Маса — це енергія тіла у стані спокою; межа між масою й енергією стирається. Для гіпотетичних [тахіонів](takhiony.md) ($v > c$) квадрат маси має бути від'ємним ($m^2 < 0$, уявна маса), що вказує на нестабільність початкового стану (див. [Надсвітлові явища](nadsvitlovi-yavyshcha.md)).
...
- **Пошук і відкриття**: елементарні частинки шукають, зіштовхуючи розігнані частинки в [прискорювачах частинок](pryskoriuvachi-chastynok.md) — кінетична енергія за $E=mc^2$ перетворюється на масу, достатню для народження нових частинок. Пошук бозона Хіґґса тривав десятиліттями (невідома маса, рідкісні події, мільярди доларів). У **2012 році** колаборації **ATLAS і CMS** на [Великому адронному колайдері](../entities/velykyi-adronnyi-kolaider.md) (ЦЕРН, Женева) оголосили про відкриття частинки з масою ~**125 ГеВ**, що відповідала збудженню поля Хіґґса. У **2013 році** Енглеру й Хіґґсу присудили Нобелівську премію.
...
- [Прискорювачі частинок](pryskoriuvachi-chastynok.md) — експериментальні установки для перетворення кінетичної енергії частинок у масу нових короткоживучих об'єктів ($E=mc^2$).
- [Великий адронний колайдер](../entities/velykyi-adronnyi-kolaider.md) — експериментальний комплекс ЦЕРН, у якому було відкрито бозон Гіґґса.
