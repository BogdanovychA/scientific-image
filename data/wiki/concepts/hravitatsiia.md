...
### Чорні діри
- Об'єкти, де простір-час викривлений так сильно, що ніщо (навіть світло) не може вирватися назовні — за межу *горизонту подій*. У ЗТВ існують також часово-інвертовані розв'язки — **білі діри** (в які ніщо не може увійти), а також топологічні мости простору-часу — [кротові нори](krotovi-nory.md) (міст Ейнштейна — Розена). Перший розв'язок (Шварцшильд) описує нерухому чорну діру; пізніше (Керр) знайдено розв'язок для *обертової* чорної діри (простір-час закручується, з'являється ергосфера). Детальніше — у [Мегасвіт](mehasvit.md).
