...
- **Бозон Гіґґса** — окремий бозон зі спіном 0; його поле (скалярне, з ненульовим середнім значенням у вакуумі; передбачене Ф. Енглером, Р. Браутом і П. Гіґґсом у 1960-х, підтверджене на [Великому адронному колайдері](../entities/velykyi-adronnyi-kolaider.md) колабораціями ATLAS і CMS у 2012 р., маса ~125 ГеВ, Нобелівська премія 2013 р.) пронизує весь простір і **надає масу елементарним частинкам через взаємодію з вакуумом**: чим сильніше частинка взаємодіє з цим полем, тим вона масивніша (фотон не взаємодіє — тому безмасовий). Пошук і створення таких короткоживучих частинок здійснюється на [прискорювачах частинок](pryskoriuvachi-chastynok.md). Не має античастинки. Медійна назва «частинка Бога» — хибна (походить від скороченого «The Goddamn Particle»); сам бозон нічого не створює й не є джерелом маси в прямому сенсі. Детальніше — у [Маса](masa.md).
...
- [Прискорювачі частинок](pryskoriuvachi-chastynok.md) — інструмент створення та дослідження елементарних частинок високих енергій.
- [Великий адронний колайдер](../entities/velykyi-adronnyi-kolaider.md) — найбільша в світі експериментальна установка для підтвердження Стандартної моделі та відкриття бозона Гіґґса.
