...
- **Інші типи**: лазери на барвниках (родамін 6G), лазери на вільних електронах (*Free Electron Laser* — надскладні прилади на прискорених електронах в ондуляторі; в Україні ніколи не існували), лазери на канальованих електронах у скрещених полях (нова схема, запропонована [Михайлом Висоцьким](../entities/mykhailo-vysotskyy.md) у 2024 році), а також тандемний лазер на рухомих частинках, схему якого він також розробив (у ньому кінетична енергія частинки перетворюється на когерентне випромінювання).
...
- **Когерентність**: усі фотони мають однакову фазу, поляризацію й майже ідентичний напрямок. Це дозволяє формувати вузькі пучки, що не розходяться на величезні відстані — наприклад, лазером вимірюють відстань до Місяця з точністю до міліметрів. Швидке змітання лазерного променя по поверхні Місяця створює пляму, що рухається швидше за $c$, як суто геометричний ефект без передачі інформації (див. [Надсвітлові явища](nadsvitlovi-yavyshcha.md)).
