...
- **Природа розширення — народження простору**: розширення — це не рух галактик крізь простір, а породження нового простору між ними (як точки на надувній кульці). Тому далекі галактики (на відстанях понад ~14 млрд св. років) віддаляються швидше за світло ($v = H_0 d > c$) за рахунок розширення самої метрики FLRW (див. [Надсвітлові явища](nadsvitlovi-yavyshcha.md)), що формує космологічний горизонт подій — обмеження швидкості світла стосується локального руху крізь простір, а не метричного розширення простору-часу. Центру розширення в нашому тривимірному просторі немає; будь-яку точку можна вважати центром, а справжній «центр» лежить у часі (четвертий вимір) — у моменті Великого вибуху.
...
- **Космічна інфляція**: надзвичайно швидке роздуття (Алан Гут, 1980-ті) Всесвіту за частку секунди ($10^{-36}\text{--}10^{-32}\text{ с}$), під час якого розмір простору збільшився у $10^{26}$ разів, а швидкість розширення країв інфляційної бульбашки перевищувала $c$ у $10^{15}$ разів (див. [Надсвітлові явища](nadsvitlovi-yavyshcha.md)). Інфляція розв'язала фундаментальні проблеми горизонту, площинності та магнітних монополів.
