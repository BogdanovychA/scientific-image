...
- **Швидкість світла та шлях до Землі**: у відкритому просторі фотон рухається з максимальною можливою швидкістю $c \approx 300\,000\text{ км/с}$ і долає ~150 млн км за ~8,5 хвилин. Швидкість світла у вакуумі є не просто швидкістю фотонів, а фундаментальним коефіцієнтом зв'язку простору й часу ($1\text{ с} \approx 300\,000\text{ км}$) та абсолютною межею причинності (див. [Надсвітлові явища](nadsvitlovi-yavyshcha.md)). У середовищах із $n < 1$ (плазма, хвилеводи) фазова швидкість світла $v_{\text{фаз}} = c/n$ перевищує $c$, але групова швидкість сигналу завжди $v_{\text{груп}} \le c$; рух заряджених частинок швидше за світло у середовищі ($v > c/n$) породжує випромінювання Вавилова — Черенкова.
